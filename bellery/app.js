...
(function($) {
	...
	$(document).on('click', '.product-item__description--actions .nova_product_quick_view_btn',  function() {
		var this_button = $(this);
		this_button.addClass('clicked');
		this_button.parents('.product-item').addClass('adding');
		setTimeout(function() {
...
jQuery(function($) {
	...
	function special_effect_button(element) {
		...
		var tween2 = new mojs.Shape({
			...
			radius: 		{0: 30},
			fill: 			'transparent',
			stroke: 		nova_js_var.accent_color,
			strokeWidth: {10:0},
			opacity: 		0.6,
			duration: 	700,
	...
	$(document).on('click', 'ul.products .product .product-item__description--actions > .nova_product_wishlist_btn',  function() {
		special_effect_button(this);
	});

	$(document).on('click', 'ul.products .product .product-item__description--actions > .nova_product_quick_view_btn',  function() {
		special_effect_button(this);
	});

	$(document).on('click', 'ul.products .product .product-item__description--actions > .button',  function() {
		special_effect_button(this);
	});
...
//@codekit-prepend "../_vendor/foundation/dist/js/foundation.min.js"
//@codekit-prepend "../_vendor/cookies/js.cookie.js"
//@codekit-prepend "../_vendor/tweenmax/tweenmax.min.js"
//@codekit-prepend "../_vendor/jquery-visible/jquery.visible.js"
//@codekit-prepend "../_vendor/imagesloaded/imagesloaded.pkgd.js"
//@codekit-prepend "../_vendor/scrollTo/jquery.scrollTo.min.js"
//@codekit-prepend "../_vendor/hoverIntent/jquery.hoverIntent.min.js"
//@codekit-prepend "../_vendor/mojs/mo.min.js"
//@codekit-prepend "../_vendor/anime/anime.min.js"
//@codekit-prepend "../_vendor/swiper/js/swiper.js"
//@codekit-prepend "../_vendor/headroom.js/headroom.min.js"
//@codekit-prepend "../_vendor/sticky-kit/jquery.sticky-kit.min.js"
//@codekit-prepend "../_vendor/scroll-magic/ScrollMagic.min.js"
//@codekit-prepend "../_vendor/slick/slick.min.js"
//@codekit-prepend "../_vendor/instafeed/instafeed.min.js"
...
//@codekit-prepend "components/product/_sticky.js"
